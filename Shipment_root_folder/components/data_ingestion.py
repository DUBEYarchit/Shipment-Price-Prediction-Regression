...
from Shipment_root_folder.Entity.config_entity import DataIngestionConfig
from Shipment_root_folder.Entity.artifacts_entity import DataIngestionArtifacts
from Shipment_root_folder.constant import TEST_SIZE
